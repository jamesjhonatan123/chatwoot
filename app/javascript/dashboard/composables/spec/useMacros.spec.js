...
describe('useMacros', () => {
      ...
      actions: [
        {
          ...
          action_params: ['https://example.com/hook'],
        },
      ],
    };
  ...
  // change_status entra na lista do construtor de macros por causa do nosso
  // fluxo de follow-up, entao o preview mostra o rotulo traduzido, nao o id.
  it('resolves change_status through the dropdown labels', () => {
    const { resolveMacroActions } = useMacros();
    const macro = {
    ...
    expect(resolveMacroActions(macro)).toEqual([
      {
        ...
        actionValue: 'CHAT_LIST.CHAT_STATUS_FILTER_ITEMS.resolved.TEXT',
      },
    ]);
  });
