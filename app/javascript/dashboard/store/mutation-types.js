export default {
  ...
  SET_MEDIA_ASSETS_UI_FLAG: 'SET_MEDIA_ASSETS_UI_FLAG',
  SET_MEDIA_ASSETS: 'SET_MEDIA_ASSETS',
  ADD_MEDIA_ASSET: 'ADD_MEDIA_ASSET',
  EDIT_MEDIA_ASSET: 'EDIT_MEDIA_ASSET',
  DELETE_MEDIA_ASSET: 'DELETE_MEDIA_ASSET',

  SET_FOLLOW_UPS_UI_FLAG: 'SET_FOLLOW_UPS_UI_FLAG',
  SET_CONVERSATION_FOLLOW_UPS: 'SET_CONVERSATION_FOLLOW_UPS',
  ADD_CONVERSATION_FOLLOW_UP: 'ADD_CONVERSATION_FOLLOW_UP',
  DELETE_CONVERSATION_FOLLOW_UP: 'DELETE_CONVERSATION_FOLLOW_UP',
  SET_DUE_FOLLOW_UPS: 'SET_DUE_FOLLOW_UPS',
  SET_FOLLOW_UP_WORKFLOWS: 'SET_FOLLOW_UP_WORKFLOWS',
  ADD_FOLLOW_UP_WORKFLOW: 'ADD_FOLLOW_UP_WORKFLOW',
  EDIT_FOLLOW_UP_WORKFLOW: 'EDIT_FOLLOW_UP_WORKFLOW',
  DELETE_FOLLOW_UP_WORKFLOW: 'DELETE_FOLLOW_UP_WORKFLOW',
  SET_FOLLOW_UP_ANALYTICS: 'SET_FOLLOW_UP_ANALYTICS',
  SET_FOLLOW_UP_HISTORY: 'SET_FOLLOW_UP_HISTORY',
  UPDATE_FOLLOW_UP_HISTORY_ITEM: 'UPDATE_FOLLOW_UP_HISTORY_ITEM',
  UPDATE_CONVERSATION_FOLLOW_UP: 'UPDATE_CONVERSATION_FOLLOW_UP',
